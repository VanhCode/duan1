                            ...
                            <div class="kvXy0c">
                                <div class="-78s2g"><span class="JMmT2C">
                                        <div class="IlORNJ" tabindex="0"><svg width="16" height="17" viewBox="0 0 253 263" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <title>VanhStore Guarantee</title>
                                ...
                                <section class="EOjXew">
                                    ...
                                    <?php
                                        if($detail['status'] == 'pending' || $detail['status'] == 'confirmed') {
                                            ...
                                            ?>
                                                <div class="PF0-AU">
                                                    <a href="index.php?action=chi-tiet-sanpham&detail_product=<?= $detail['product_id'] ?>"><button class="stardust-button stardust-button--primary WgYvse">Mua lại</button></a>
                                                </div>
                                                <div class="PgtIur">
