<div class="single-box">
    <div class="nav-form">
        <ul>
            ...
            <li class="abill <?= $order == 'dang-giao' ? 'activeNav' : "" ?>"><a class="<?= $order == 'dang-giao' ? 'sticky' : "" ?>" href="index.php?action=user&user=don-mua&order=dang-giao">Đang giao <?= !empty($load_order_danggiao) ? "(".count($load_order_danggiao).")" : "" ?></a></li>
            <li class="abill <?= $order == 'hoan-thanh' ? 'activeNav' : "" ?>"><a class="<?= $order == 'hoan-thanh' ? 'sticky' : "" ?>" href="index.php?action=user&user=don-mua&order=hoan-thanh">Hoàn thành <?= !empty($load_order_hoanthanh) ? "(".count($load_order_hoanthanh).")" : "" ?></a></li>
            <li class="abill <?= $order == 'da-huy' ? 'activeNav' : "" ?>"><a class="<?= $order == 'da-huy' ? 'sticky' : "" ?>" href="index.php?action=user&user=don-mua&order=da-huy">Đã hủy <?= !empty($load_order_dahuy) ? "(".count($load_order_dahuy).")" : "" ?></a></li>
