                                               ...
                                               <div style="pointer-events: auto;">
                                                   <button class="sort-price-select">
                                                       ...
                                                       <ul class="price-hover__desc">
                                                           <li><a href="index.php?action=search&keyword=<?= $_POST['keyword']??$_GET['keyword'] ?>&gia-thap-cao">Giá: Thấp đến Cao</a></li>
                                                           <li><a href="index.php?action=search&keyword=<?= $_POST['keyword']??$_GET['keyword'] ?>&gia-cao-thap">Giá: Cao đến Thấp</a></li>
                                                       </ul>
                                                   </button>
                                               </div>
                                           </section>
