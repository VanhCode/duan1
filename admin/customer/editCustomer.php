                        ...
                        <div class="start-radio-group d-flex gap-3" role="radiogroup">
                            <div class="radio-group-item d-flex">
                                <div class="input-radio">
                                    <input <?=$user['gender']==='Nam'?'checked':''?> type="radio" name="gender" value="Nam">
                                </div>
                            ...
                            <div class="radio-group-item d-flex">
                                <div class="input-radio">
                                    <input <?=$user['gender']==='Nữ'?'checked':''?> type="radio" name="gender" value="Nữ">
                                </div>
                                <div class="radio-text">
                                    <span>Nữ</span>
                                </div>
                            ...
                            <div class="radio-group-item d-flex">
                                <div class="input-radio">
                                    <input <?=$user['gender']==='Khác'?'checked':''?> type="radio" name="gender" value="Khác">
                                </div>
                                <div class="radio-text">
                                    <span>Khác</span>
                                </div>
