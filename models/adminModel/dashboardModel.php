...
function newOrder($day=7){
    $sql="SELECT u.user_id,o.order_id,CONCAT(u.firth_name,' ',u.last_name) AS fullName,u.user_image,o.receiver_name,o.receiver_address,o.receiver_phone,o.status,date(o.create_at) as create_at,SUM(od.price * od.amount) AS total
    FROM `orders` o
    JOIN users u
