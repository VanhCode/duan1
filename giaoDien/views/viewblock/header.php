                ...
                <div class="btn-span">
                        <!-- <nav class="navTop">
                            <ul class="userTop">
                                ...
                                <li class="boxUser">
                                    <a href="./view/user.php" class="userLog nomation"><i class="fa-solid fa-user"></i> Vanh</a>
                                    <ul class="userChil">
                        ...
                        <a class="signup nomation" href="index.php?url=dangky"><i class="fa fa-user-edit"></i> Đăng ký</a>
                        <div class="line-top"></div>
                        <a class="login nomation" href="index.php?url=dangnhap"><i class="fa fa-sign-in"></i> Đăng nhập</a>
                </div>
            </div>
